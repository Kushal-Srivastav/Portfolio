...
export const PinContainer = ({
  ...
  return (
    <Link
      className={cn(
        "relative group/pin z-50 cursor-pointer h-[400px]",
        containerClassName
      )}
...
export const PinPerspective = ({
  ...
  return (
    <motion.div className="pointer-events-none w-full h-[400px] flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
